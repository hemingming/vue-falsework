<template>
  <bl-popup v-model="visible" position="bottom" class="bl-datetime">
    <bl-picker
      :slots="dateSlots"
      @change="onChange"
      @finish="pickerLoaded"
      :visible-item-count="visibleItemCount"
      class="bl-datetime-picker"
      ref="picker"
      show-toolbar>
      <div class="toolbar-head">
        <span class="bl-datetime-action bl-datetime-cancel" @click="visible = false">{{ cancelText }}</span>
        <span class="bl-datetime-action bl-datetime-confirm" @click="confirm">{{ confirmText }}</span>
      </div>
...
<style lang="scss">
  ...
  .bl-datetime .picker-slot-wrapper, .bl-datetime .picker-item {
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      confirm() {
        this.visible = false;
        this.$emit('confirm', this.getValue(this.values), this.values);
      },
